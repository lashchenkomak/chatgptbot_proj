...
ROLE_MESSAGES = {
    'language_learning': 'You selected the role to learn foreign languages. 📚\n'
                         'Now you can ask me your questions or tasks, or ask me to create custom exercises for you!',
    'programming_helper': 'You selected the role to study programming. 💻\n'
                          'Feel free to ask me for code, explanations, or custom tasks to practice!',
    'psychologist': 'You selected the psychologist role. 🧠\n'
                    'Share your thoughts or feelings, and I\'ll do my best to help.',
    'essay_writer': 'You selected the essay writing role. 📝\n'
